...
export const auditEventTypes = [
  ...
  "TRANSACTION_PLACEHOLDER_CREATED",
  "BILL_PAY_REQUEST_SUBMITTED",
  "CARD_CONTROL_REQUEST_SUBMITTED",
  "STAKING_ELIGIBILITY_SUBMITTED",
  "CRYPTO_ETF_INTEREST_SUBMITTED",
  "DIGITAL_ASSET_ELIGIBILITY_SUBMITTED",
  "BOND_TREASURY_REQUEST_SUBMITTED",
  "ETF_INTEREST_REQUEST_SUBMITTED",
  "PORTFOLIO_PREFERENCE_SUBMITTED",
  "INVESTMENT_ACCOUNT_APPLICATION_SUBMITTED",
  "SUITABILITY_REVIEW_SUBMITTED",
